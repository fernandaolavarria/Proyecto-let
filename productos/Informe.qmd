...
De aquí se puede afirmar en primer lugar que este gráfico sigue casi la misma relación que el gráfico previo de accidentes. En segundo lugar, a lo sumo dos personas resultan heridas en estos incidentes. Por último, las dos subcategorías que provocan más heridos son "otros" y "desviación del camino"
...
Por último, a pesar de que este análisis involucró solamente a un país, no deja de ser de interés para los demás paises. Esto debido a que en casi la mayoría de las sociedades se tiene que lidiar con esta convivencia peatonal-vehicular, y en donde no se está exento de la ocurrencia de estos eventos muchas veces trágicos.
