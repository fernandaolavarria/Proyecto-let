...
A la luz de estos hallazgos, las preguntas y objetivos planteados en el reporte es posible afimar que, por un lado, se ha advertido una notoria disminución desde el 2005 hasta el 2021 en las muertes originadas por los diversos tipos de accidentes y sus subcategorías. Sin embargo, por otro lado no se puede sostener lo mismo para la evolución de accidentes y heridos. Las tendencias de éstas no han presentado mayor cambio a favor de la caída de los casos, a pesar de sus fluctuaciones a veces irregulares en el tiempo. Esto es de suma importancia, ya que al reducir efectivamente la cantidad de accidentes, naturalmente habría una reduccion considerable de personas accidentadas y fallecidas.

Debido a lo importante que es aminorar la ocurrencia de estos incidentes, el gobierno surcoreano debería blablablabla.
